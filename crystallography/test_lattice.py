...
class TestLattice(unittest.TestCase):
  def setUp(self):
    ...
    self.Ltrigonal = lattice.Lattice(a=2, b=2, c=2, alpha=35.0/180*pi, beta=35.0/180*pi, gamma=35.0/180*pi)
...
#    self.fail("Test if the testcase is working.")
  ...
  def testLattice(self):
    ...
    #trigonal
    self.assert_(almostEqual(self.Ltrigonal.a, 2.0))
    self.assert_(almostEqual(self.Ltrigonal.b, 2.0))
    self.assert_(almostEqual(self.Ltrigonal.c, 2.0))
    self.assert_(almostEqual(self.Ltrigonal.a_, 0.9763044673403796))
    self.assert_(almostEqual(self.Ltrigonal.b_, 0.9763044673403796))
    self.assert_(almostEqual(self.Ltrigonal.c_, 0.9763044673403796))
    self.assert_(almostEqual(self.Ltrigonal.alpha, 35.0/180*pi))
    self.assert_(almostEqual(self.Ltrigonal.beta, 35.0/180*pi))
    self.assert_(almostEqual(self.Ltrigonal.gamma, 35.0/180*pi))
    self.assert_(almostEqual(self.Ltrigonal.alpha_, 2.0378901672656156))
    self.assert_(almostEqual(self.Ltrigonal.beta_, 2.0378901672656156))
    self.assert_(almostEqual(self.Ltrigonal.gamma_, 2.0378901672656156))
    self.assert_(almostEqual(self.Ltrigonal.volume, 2.349990010446501))
    self.assert_(almostEqual(self.Ltrigonal.volume_, 0.42553372378378695))
