...
.. inheritance-diagram:: test_calculations
...
class TestCalculations(unittest.TestCase):
  ...
  def setUp(self):
    ...
    self.triclinic = unitcell.create_triclinic_unitcell(1, 2, 3
                                                        , 75.0 / 180 * pi
                                                        , 55.0 / 180 * pi
                                                        , 35.0 / 180 * pi)
  ...
  def testare_planes_equivalent(self):
    ...
    self.assertTrue(calculations.are_planes_equivalent(plane1
                                                       , plane2
                                                       , self.cubic))
  ...
  def testmaximum_formfactor(self):
    #FCC
    maximum = calculations.maximum_formfactor(self.cubic
                                              , self.atomsfcc
                                              , self.scatter)
    ...
    # HCP
    maximum = calculations.maximum_formfactor(self.hexagonal
                                              , self.atomshcp
                                              , self.scatter)
    expected_maximum = 27.9952
    self.assertAlmostEqual(maximum, expected_maximum)
  ...
  def testdiffraction_maxintensity(self):
    #FCC
    maximum = calculations.diffraction_maxintensity(self.cubic
                                                    , self.atomsfcc
                                                    , self.scatter)
    ...
    # HCP
    maximum = calculations.diffraction_maxintensity(self.hexagonal
                                                    , self.atomshcp
                                                    , self.scatter)
    expected_maximum = 27.9952 ** 2
    self.assertAlmostEqual(maximum, expected_maximum)
